...
Det er kun redaksjonelle endringer fra versjon 2.0 til 2.0.x, som ikke beskrives her i vedlegget. Ta kontakt med mailto:informasjonsforvaltning@digdir.no[Digitaliseringsdirektoratet, Forvaltningsstandard for begrepsbeskrivelser - redaksjonelle endringer] ved behov for å se de redaksjonelle endringene. 

Med redaksjonelle endringer menes endringer i formatering/strukturering eller formulering av tekst/tegninger/tabeller som ikke endrer kravene i standarden. 
