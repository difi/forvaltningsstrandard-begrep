...
Det er kun redaksjonelle endringer fra versjon 2.0 til 2.0.x, som ikke beskrives her i vedlegget. mailto:informasjonsforvaltning@digdir.no[Ta kontakt med Digitaliseringsdirektoratet,"Forvaltningsstandard for begrepsbeskrivelser - redaksjonelle endringer",] ved behov for å se de redaksjonelle endringene. 
