...
Standarden inngår i https://www.digdir.no/digitalisering-og-samordning/begrepsanalyse-og-definisjonsarbeid/1483[bruksområdet “Begrepsanalyse og definisjonsarbeid”] i _Referansekatalogen_. Denne versjonen skal erstatte den første versjonen fra mai 2012.
...
* NS-ISO 1087:2019 _Terminologiarbeid og terminologivitenskap — Ordliste_
