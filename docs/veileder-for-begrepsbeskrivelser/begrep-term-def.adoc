...
.Forholdet mellom begrep, term, definisjon og referent (fra http://www.sprakradet.no/globalassets/vi-og-vart/publikasjoner/termlosen.pdf[Termlosen], omgrep er nynorsk for begrep på bokmål)  
[caption="Figur 1: "]
image::https://github.com/difi/forvaltningsstandard-begrep/blob/master/docs/veileder-for-begrepsbeskrivelser/begrep.png?raw=true[]
